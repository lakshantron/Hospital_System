...
if (isset($_POST["btnAdd"])) {
    try {
        ...
        $Assistence->SetWard($_POST["txtWard_PatientPulse"]);
        $Assistence->SetRoom($_POST["txtRoom_PatientPulse"]);
        $Assistence->SetName($_POST["txtName_PatientPulse"]);
        $Assistence->SetDescription($_POST["txtEmergency_FoodorderPulse"]);
        ...
        * {
        ...
        .hero {
            background: linear-gradient(to left, rgba(0, 0, 0, 0.3),
             rgba(0, 0, 0, 0.616)), url("Images/other assistence.jpg") var(--bg-image-center) fixed;
        }
...
<link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/bootstrap@4.0.0/dist/css/bootstrap.min.css" integrity="sha384-Gn5384xqQ1aoWXA+058RXPxPg6fy4IWvTNh0E263XmFcJlSAwiGgFAW/dAiS6JXm" crossorigin="anonymous"></head>
    ...
    we here to assist any of your needs
    </h2>
    ...
    <div class="post">
        <form method="post" enctype="multipart/form-data" name="Patientdata">
            <table>
                ...
                <tr>
            <td>reason for the assistance<span class="required"></span></td>
            <td>
        ...
        <a class='btn-sm' href='../PatientPulse/viewAssistence.php'>View Record</a>
    </div>
