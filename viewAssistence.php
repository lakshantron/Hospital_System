<style>
     * {
        ...
        .hero {
            ...
            rgba(0, 0, 0, 0.616)), url("Images/senatery.jpg") var(--bg-image-center) fixed;
        }
...
$query = "SELECT ID, Ward, Room, Name, Description FROM `other_asist`"; // Enclose `Order` in backticks
...
?>
  ...
  <a class='btn-sm' href='../PatientPulse/manageAssistence.php'>Back to Assistence Page</a>
