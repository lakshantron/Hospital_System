<?php
require("ChildPatient.php");

$saved = false;

if (isset($_POST["btnAdd"])) {
    try {
        $childrenAssist = new childrenAssist();
        $childrenAssist->SetWard($_POST["txtWard_PatientPulse"]);
        $childrenAssist->SetRoom($_POST["txtRoom_PatientPulse"]);
        $childrenAssist->SetName($_POST["txtName_PatientPulse"]);
        $childrenAssist->SetGuardian($_POST["txtGuardian_PatientPulse"]);
        $childrenAssist->SetDescription($_POST["txtEmergency_FoodorderPulse"]);

        $id = $childrenAssist->Add();
        $childrenAssist->SetId($id);
    ...
    <style>
        ...
        * {
        ...
        .hero {
            ...
            rgba(0, 0, 0, 0.616)), url("Images/international-promo.jpg") var(--bg-image-center) fixed;
        }
...
<link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/bootstrap@4.0.0/dist/css/bootstrap.min.css" integrity="sha384-Gn5384xqQ1aoWXA+058RXPxPg6fy4IWvTNh0E263XmFcJlSAwiGgFAW/dAiS6JXm" crossorigin="anonymous"></head>
    ...
    <h2 class="main-headings center">
        Welcome to Patient Pulse - Your Personalized Hospital Assistant
    </h2>
    ...
    <div class="post">
        <form method="post" enctype="multipart/form-data" name="Patientdata">
            <table>
                ...
                <tr>
                    <td>Patient Name <span class="required">*</span></td>
                    <td>
                ...
                <tr>
                    <td>Guardian status <span class="required">*</span></td>               
                    <td>
                        <input type="text" name="txtGuardian_PatientPulse" required>
                    </td>
                    <td>(only family member
                         can be a Guardian) </td>
                </tr>
        ...
        <a class='btn-sm' href='../PatientPulse/viewchildrenrecord.php'>View Record</a>
    </div>
