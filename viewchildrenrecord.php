<style>
     * {
        ...
        .hero {
            ...
            rgba(0, 0, 0, 0.616)), url("Images/Button1.webp") var(--bg-image-center) fixed;
        }
...
$query = "SELECT ID, Ward, Room, Name,Guardian, Description FROM `chilren_assist`"; // Enclose `Order` in backticks
...
?>
  ...
  <a class='btn-sm' href='../PatientPulse/managepatient.php'>Back to Children Assistence Page</a>
