<style>
     * {
        ...
        .hero {
            background: linear-gradient(to left, rgba(0, 0, 0, 0.3), rgba(0, 0, 0, 0.616)), url("Images/kkk.jpg") var(--bg-image-center) fixed;
        }
...
$query = "SELECT ID, Ward, Room, Name, Description FROM `tecnicle_assist`"; // Enclose `Order` in backticks
...
?>
  ...
  <a class='btn-sm' href='../PatientPulse/ManageTecnicle.php'>Back to Tecnicle Assist Page</a>
