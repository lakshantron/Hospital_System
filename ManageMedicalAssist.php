...
if (isset($_POST["btnAdd"])) {
    try {
        $Patient = new Patient();
        $Patient->SetWard($_POST["txtWard_PatientPulse"]);
        $Patient->SetRoom($_POST["txtRoom_PatientPulse"]);
        $Patient->SetName($_POST["txtName_PatientPulse"]);
        $Patient->SetTelephone($_POST["txtPhone_PatientPulse"]);
        $Patient->SetMedical($_POST["Type_PatientPulse"]);
    ...
    <style>
        ...
        * {
        ...
        .hero {
            ...
            rgba(0, 0, 0, 0.616)), url("Images/Medical Assst.jpg") var(--bg-image-center) fixed;
        }
...
<link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/bootstrap@4.0.0/dist/css/bootstrap.min.css" integrity="sha384-Gn5384xqQ1aoWXA+058RXPxPg6fy4IWvTNh0E263XmFcJlSAwiGgFAW/dAiS6JXm" crossorigin="anonymous"></head>
    ...
    <h2 class="main-headings center">
       We here for your any medical Emergency
    </h2>
    ...
    <div class="post">
        <form method="post" enctype="multipart/form-data" name="Patientdata">
            <table>
                ...
                <tr>
                    ...
                    <td>
                        <input type="number" name="txtPhone_PatientPulse" required>
                    </td>
                </tr>
                <tr>
                    <td>Medical Assist</td>
                    <td>
                        <select name="Type_PatientPulse" id="Type_PatientPulse">
                            <option value="late for routine check">Late for routine check</option>
                            <option value="Daily Vaccination is delayed">Daily Vaccination is delayed</option>
                            <option value="morning medicine is late">Morning medicine is late</option>
                            <option value="evening medicine is late">Evening medicine is late</option>
                        </select>
                    </td>
                </tr>
                <tr>
        ...
        <a class='btn-sm' href='../PatientPulse/MedicalTeble.php'>View Record</a>
    </div>
